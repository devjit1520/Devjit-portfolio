    ...
    >
      ...
      {!imageFailed && project.image ? (
        ...
        >
          ...
          >
            <Icon
              className={`text-5xl ${project.iconColor}`}
            />
          </div>
        </div>
      )}
      ...
      <div className="relative z-10 mx-auto max-w-[1380px]">
        ...
        >
          ...
          <p
            ...
            "
          >
            A selection of projects demonstrating my frontend
            development, problem-solving, UI design, API
            integration, and React skills.
          </p>
